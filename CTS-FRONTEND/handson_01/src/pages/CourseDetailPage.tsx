  ...
  return (
    <section className="section-card course-detail">
      ...
      <dl className="course-detail-grid">
        ...
        <div><dt>Grade</dt><dd>{course.grade}</dd></div>
      </dl>

      <div className="hero-actions">
        <button type="button" onClick={() => { dispatch(enroll(course)); navigate('/profile'); }}>Enroll now</button>
        <button type="button" className="secondary" onClick={() => navigate('/courses')}>Back to courses</button>
      </div>
    </section>
  );
}